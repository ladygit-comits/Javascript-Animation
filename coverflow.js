...
function coverflowimages(options) {
    ...
    for (var i = 0; i < options.images.length; i++) {
        ...
        frameinnerHTML += '<li style="background-image:url(pic' + (i + 1) + 'thumbnail.jpg)" data-itemindex="' + i + '"></li>\n';
...
coverflowimages({
    coverid: 'coverflow1',
    images: [
        ['pic1thumbnail.jpg', 'pic1.png', 'This is a picture of my side profile'],
        ['pic2thumbnail.jpg', 'pic2.jpeg', 'This is a picture I took after class'],
        ['pic3 thumbnail .jpg', 'pic3.jpg', 'This is my home-taken passport photo'],
        ['pic4 thumbnail.jpg', 'pic4.jpg', 'I took this picture after trying out a dress I just bought'],
        ['pic5 thumbnail.jpg', 'pic5.jpg', 'A selfie of my formal wear']
